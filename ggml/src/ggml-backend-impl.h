...
extern "C" {
    ...
    // number of member (simple) buffers of a meta buffer — i.e. the TP group size
    // of the group that owns the buffer; needed by the split-state callback when
    // TP groups have non-uniform sizes (e.g. 4+4+4+2 over 14 GPUs).
